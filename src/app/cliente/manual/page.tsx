...
export const metadata = buildPageMetadata({
  title: "Manual de marca — Soulful Branding®",
  description: "Revisá y confirmá la recepción de tu manual de marca.",
  path: "/cliente/manual",
  noIndex: true,
});
...
export default async function ClienteManualPage({ searchParams }: PageProps) {
